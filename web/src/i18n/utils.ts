...
import frPages from "./pages/fr.json";
import cs from "./translations/cs.json";
import csPages from "./pages/cs.json";
import de from "./translations/de.json";
import dePages from "./pages/de.json";
import be from "./translations/be.json";
import bePages from "./pages/be.json";
import ru from "./translations/ru.json";
import ruPages from "./pages/ru.json";
import uk from "./translations/uk.json";
import ukPages from "./pages/uk.json";
...
const dicts: Record<Locale, Record<string, unknown>> = { en, zh, ja, ko, th, vi, pl, es, uk, ru, be, de, cs, fr };
...
const pageDicts: Partial<Record<Locale, PageDict>> = { en: enPages, zh: zhPages, ja: jaPages, ko: koPages, th: thPages, vi: viPages, pl: plPages, es: esPages, uk: ukPages, ru: ruPages, be: bePages, de: dePages, cs: csPages, fr: frPages };

...
const dicts: Record<Locale, Record<string, unknown>> = { en, zh, ja, ko, th };
...
const pageDicts: Partial<Record<Locale, PageDict>> = { en: enPages, zh: zhPages, ja: jaPages, ko: koPages, th: thPages };

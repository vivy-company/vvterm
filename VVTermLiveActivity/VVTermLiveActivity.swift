...
@available(iOS 16.1, *)
struct VVTermLiveActivityWidget: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: VVTermActivityAttributes.self) { context in
            VVTermLiveActivityLockScreenView(context: context)
...
@available(iOS 16.1, *)
private struct VVTermLiveActivityLockScreenView: View {
    let context: ActivityViewContext<VVTermActivityAttributes>
